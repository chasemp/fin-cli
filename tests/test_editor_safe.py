...
class TestEditorSafe:
    ...
    def test_create_edit_file_content(self, temp_db_path):
        ...
        with db_manager.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute("UPDATE tasks SET completed_at = ? WHERE content = ?", 
        ...
        assert lines[7] == "# DO NOT modify the #ref:task_XXX part - it's used to track changes"
        assert lines[8] == ""
    ...
    def test_parse_edited_content_no_changes(self, temp_db_path):
        ...
        completed_count, reopened_count, new_tasks_count, deleted_count = editor_manager.parse_edited_content(original_content)
...
"""
        ...
        # Parse the content
        completed_count, reopened_count, new_tasks_count, deleted_count = editor_manager.parse_edited_content(invalid_content)
    ...
    def test_simulate_edit_with_content(self, temp_db_path):
        ...
        # Simulate the edit
        completed_count, reopened_count, new_tasks_count, deleted_count = editor_manager.simulate_edit_with_content(
...
"""
    ...
    def test_text_transform_edge_cases(self, temp_db_path):
        ...
        for i, edge_case in enumerate(edge_cases):
            ...
            completed_count, reopened_count, new_tasks_count, deleted_count = editor_manager.parse_edited_content(edge_case)
    ...
    def test_text_transform_task_deletion(self, temp_db_path):
        ...
        # Parse the modified content
        completed_count, reopened_count, new_tasks_count, deleted_count = editor_manager.parse_edited_content(
