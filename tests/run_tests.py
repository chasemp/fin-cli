...
def run_shell_tests():
    ...
    result = subprocess.run(["bash", str(shell_test_path)], 
...
def run_integration_tests():
    ...
    test_commands = [
        ["python", "-m", "fin.cli.main", "--help"],
        ["python", "-m", "fin.cli.main", "Integration test task"],
        ["python", "-m", "fin.cli.main", "Task with labels", "--label", "test"],
    ]
...
def main():
    ...
    parser.add_argument("--type", choices=["unit", "integration", "cli", "database", "all"],
